...
class ArenaTemplate extends TemplateRoot {
  ...
  createArena(arena) {
    ...
    if (arena.digArena && arena.hero.accessorie && arena.hero.accessorie.role === "diggeable") {
...
const openModal = (type) => {
  if (openingModal) {
    ...
    if (type === "hero") info.createHeroInfoTemplate(arena.hero);
    if (type === "ennemy") info.createEnnemyInfoTemplate(arena.monsters);
